...
/// Delivery container for a pending proactive insight
struct PendingInsightDelivery: Equatable {
...
final class LumaProactiveService: ObservableObject {
    ...
    @Published var pendingDelivery: PendingInsightDelivery?
    ...
    func checkAndDeliverPendingInsight() {
        ...
        pendingDelivery = PendingInsightDelivery(event: event, insight: pending)
    }
