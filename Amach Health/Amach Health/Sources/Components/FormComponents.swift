...
enum AmachTextAutocapitalization {
    case never
    case words
    case sentences
    case characters
...
struct AmachTextField: View {
    ...
    var textContentType: UIKit.UITextContentType? = nil
    #endif
    var autocapitalization: AmachTextAutocapitalization = .sentences
    var onSubmit: (() -> Void)?     = nil

    @FocusState private var isFocused: Bool

    #if os(iOS) || os(tvOS)
    private var autocapitalizationUIKit: UITextAutocapitalizationType {
        ...
        VStack(alignment: .leading, spacing: AmachSpacing.xs) {
            HStack(spacing: AmachSpacing.sm) {
                ...
                TextField(placeholder, text: $text)
                    ...
                    .autocapitalization(autocapitalizationUIKit)
                    #endif
                    .focused($isFocused)
                    .onSubmit { onSubmit?() }
